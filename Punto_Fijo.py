...
def Ventana_Punto_Fijo(frame,ventana2,ventana):
    ...
    ingreso_valor_real = ctk.CTkEntry(marco_ingreso_valores,width=200,height=30,corner_radius=10,font = tipo_tamaño_letra_ventana2,text_color=color_texto_ventana2)
    ingreso_valor_real.place(x=675,y=60)
    ...
    def Validacion():
        ...
        if valor_inicial == "" and  cifras_significativas == "" and valor_real == "" and funcion == "":
            messagebox.showerror("¡ ERROR CRITICO !",message="Debe llenar todos los campos")
        #SI uno o varios estan vacios
        elif valor_inicial == ""  or cifras_significativas == "" or valor_real == "" or funcion == "":
            messagebox.showerror("¡ ERROR CRITICO !",message="Debe llenar todos los campos")
            ...
            if numero_valido(valor_inicial)  and numero_valido(cifras_significativas)  :
                if Validacion_Funcion(funcion) == True and Validacion_Funcion(valor_real) == True:
                    ...
                    Punto_Fijo(valor_real,funcion,valor_inicial,cifras_significativas,muestra_valores,muestra_tabla,muestra_raiz,muestra_grafica)
                    ...
                    messagebox.showerror("¡ ERROR CRITICO !",message="Ingrese las funciones en terminos 'x' y sin dejar espacios ")
