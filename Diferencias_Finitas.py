        ...
        if seleccion_formula == "" and seleccion_derivada == "" and valor_h == "" and punto == "" and funcion == "":
            ...
            if numero_valido(punto) and numero_valido(valor_h):
                if Validacion_Funcion(funcion):
                    ...
                    muestra_titulo = ctk.CTkLabel(marco_muestra_valores,font=("Currier",20,"bold"))
                    muestra_valores = ctk.CTkLabel(marco_muestra_valores,font=("Currier",15,"bold"))
                    muestra_primer_formula = ctk.CTkLabel(marco_muestra_valores,font=("Currier",15,"bold"))
                    muestra_segunda_formula = ctk.CTkLabel(marco_muestra_valores,font=("Currier",15,"bold"))
