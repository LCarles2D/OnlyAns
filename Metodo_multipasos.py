...
def Ventana_Metodo_Multipasos(frame,ventana2,ventana):
    ...
    etiqueta_ingreso_valor_a= ctk.CTkLabel(marco_muestra_valores,text = "Hubo un problema en la realizacion del metodo multipasos ...",font=("Currier",15,"bold"))
