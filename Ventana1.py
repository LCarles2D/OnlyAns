...
from Extrapolacion_Richardson import Volver,Ventana_Extrapolacion_Richardson
...
def Activar_Extrapolacion_Richardson():#✅
    ...
    Ventana_Extrapolacion_Richardson(frame,ventana2,ventana)
...
def Activar_Cuadratura_Gaussiana():
    ...
    Ventana_Cuadratura_Gaussiana(frame,ventana2,ventana)
...
def Activar_Metodo_Euler_Completo():#✅
    ...
    Ventana_Metodo_Euler(frame,ventana2,ventana)
...
def Activar_Metodo_Euler_Modificado():#✅
    ...
    ventana2.resizable(False,False)
    ventana2.protocol("WM_DELETE_WINDOW", "onexit")  # desactivar el boton de cerrar
    ventana2.title("Metodo Euler Modificado") 
    ...
    Ventana_Metodo_Euler_Modificado(frame,ventana2,ventana)
...
botones_dentro_activados_metodos_euler = False

#Botones dentro de euler
boton_euler_completo = None
boton_euler_modificado = None
#---------------------------------------------------------------------------------------
...
def Ventana_Principal():
    ...
    #---------------------------------------------------------------------------------------
    def Botones_Metodo_Euler():
        global botones_activados
        global boton_euler_completo
        global boton_euler_modificado
        ...
        global botones_dentro_activados_metodos_euler

        if not botones_dentro_activados_metodos_euler:

            boton_euler_completo = ctk.CTkButton(ventana,text = "Metodo Euler",command=Activar_Metodo_Euler_Completo,fg_color = color_fondo_boton,text_color = color_texto,font = tipo_tamaño_letra,height = 80,width=250,hover_color=color_boton_pasar_mouse,border_color=color_borde,border_width=ancho_borde)
            boton_euler_completo.place(x=400,y=250)

            boton_euler_modificado  = ctk.CTkButton(ventana,text = "Metodo Euler Modificado",command=Activar_Metodo_Euler_Modificado,fg_color = color_fondo_boton,text_color = color_texto,font = tipo_tamaño_letra,height = 80,width=250,hover_color=color_boton_pasar_mouse,border_color=color_borde,border_width=ancho_borde)
            boton_euler_modificado.place(x=700,y=250)

            botones_dentro_activados_metodos_euler=True
        else:
            boton_euler_completo.destroy()
            boton_euler_modificado.destroy()
    ...
    def Botones_Unidad_5():
        ...
        if not botones_activados and not botones_dentro_activados_metodos_euler:

            boton_metodo_euler = ctk.CTkButton(ventana,text="Metodo de Euler",command=Botones_Metodo_Euler,fg_color = color_fondo_boton,text_color = color_texto,font = tipo_tamaño_letra,height = 80,width=250,hover_color=color_boton_pasar_mouse,border_color=color_borde,border_width=ancho_borde)
            ...
            if botones_dentro_activados_metodos_euler==False:
            ...
            elif botones_dentro_activados_metodos_euler==True:
                boton_euler_completo.destroy() 
                boton_euler_modificado.destroy() 
